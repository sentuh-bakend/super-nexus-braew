    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-primary via-accent to-primary">
        ...
        <motion.div
          ...
          className="absolute top-20 right-20 h-32 w-32 rounded-2xl border border-primary-foreground/20 bg-primary-foreground/5 backdrop-blur-sm"
        />
        <motion.div
          animate={{ y: [0, 15, 0], rotate: [0, -3, 0] }}
          transition={{ duration: 8, repeat: Infinity, ease: "easeInOut", delay: 1 }}
          className="absolute bottom-32 left-16 h-24 w-24 rounded-full border border-primary-foreground/20 bg-primary-foreground/5 backdrop-blur-sm"
        />
        <motion.div
          animate={{ y: [0, -10, 0] }}
          transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 2 }}
          className="absolute top-1/2 right-1/3 h-16 w-16 rounded-lg border border-primary-foreground/15 bg-primary-foreground/5 backdrop-blur-sm rotate-45"
        />
